...
import { INSTANCE_CONDITIONS, INSTANCE_CONDITION_LABELS, LOCATION_KIND_LABELS, type InstanceCondition, type LocationKind, type WarrantyStatus, locationLabel } from "@shared/warehouse";
                    ...
                    <SelectContent>
                      {moveTargets.map((l) => (
                        <SelectItem key={l.id} value={String(l.id)}>
                          {locationLabel(l)} · {LOCATION_KIND_LABELS[l.kind as LocationKind]}
                        </SelectItem>
                      ))}
                    </SelectContent>
                  </Select>
