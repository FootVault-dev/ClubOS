...
// Commercial term: 15% of Gross Revenue only — NO power, waste, or food clauses
  ...
  sections: [
    {
      ...
      items: [
        ...
        { kind: "bullet", text: "Commission (Event Fee): 15% of your Gross Revenue over the trading period, plus GST (clause 4). There is no stall fee, power charge, or waste charge." },
    ...
    },
    {
      ...
      items: [
        { kind: "p", text: "4.1  In consideration of the licence, the Vendor must pay the Club a commission (the Event Fee) equal to 15% of Gross Revenue generated by the Vendor at the Event over the trading period, plus GST. No stall fee, power charge, or waste charge applies." },
  ...
  try {
    ...
    const res = await client.query(
      ...
      [
        ...
        "Licence to Occupy for non-food vendors / pop-up stalls (apparel, merchandise, accessories) at the Christchurch International Cup, signed on a branded web page. 15% of Gross Revenue only — no power/waste/food clauses.",
